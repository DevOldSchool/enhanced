...
import com.enhanced.npc.CombatStyleRecommendation;
...
public class InspectPanel extends PluginPanel
{
	...
	private static final String ICON_PATH = "/com/enhanced/icons/";
	private static final String EQUIPMENT_SLOT_PATH = "/com/enhanced/equipment-slots/";
	...
	private void addCacheManagement()
	{
		...
		JButton allButton = panelButton("Clear all Enhanced cache");
